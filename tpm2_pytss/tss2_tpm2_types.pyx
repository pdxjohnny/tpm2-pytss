...
# from .tss2_common cimport (
#     UINT32,
# )

ctypedef UINT32 TPMS_AC_OUTPUT
TPM2_MAX_AC_CAPABILITIES = 2
...
TPM2_MAX_COMMAND_SIZE  = 4096 # maximum size of a command
TPM2_MAX_RESPONSE_SIZE = 4096 # maximum size of a response

# TPM constants for buffer sizes
TPM2_NUM_PCR_BANKS      = 16
TPM2_MAX_DIGEST_BUFFER  = 1024
TPM2_MAX_NV_BUFFER_SIZE = 2048
TPM2_MAX_PCRS           = 32
TPM2_MAX_ALG_LIST_SIZE  = 128
TPM2_MAX_CAP_CC         = 256
TPM2_MAX_CAP_BUFFER     = 1024
TPM2_MAX_CONTEXT_SIZE   = 5120

# Hash algorithm sizes
TPM2_SHA_DIGEST_SIZE     = 20
TPM2_SHA1_DIGEST_SIZE    = 20
TPM2_SHA256_DIGEST_SIZE  = 32
TPM2_SHA384_DIGEST_SIZE  = 48
TPM2_SHA512_DIGEST_SIZE  = 64
TPM2_SM3_256_DIGEST_SIZE = 32

# Encryption algorithm sizes
TPM2_MAX_SYM_BLOCK_SIZE = 16
TPM2_MAX_SYM_DATA       = 256
TPM2_MAX_ECC_KEY_BYTES  = 128
TPM2_MAX_SYM_KEY_BYTES  = 32
TPM2_MAX_RSA_KEY_BYTES  = 512

# Capability buffer sizes*/
TPM2_LABEL_MAX_BUFFER = 32
#TPM2_PCR_SELECT_MAX      = ((TPM2_MAX_PCRS + 7) / 8)
#TPM2_MAX_CAP_HANDLES     = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPM2_HANDLE))
#TPM2_MAX_CAP_ALGS        = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPMS_ALG_PROPERTY))
#TPM2_MAX_TPM_PROPERTIES  = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPMS_TAGGED_PROPERTY))
#TPM2_MAX_PCR_PROPERTIES  = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPMS_TAGGED_PCR_SELECT))
#TPM2_MAX_ECC_CURVES      = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPM2_ECC_CURVE))
#TPM2_MAX_TAGGED_POLICIES = ((TPM2_MAX_CAP_BUFFER - sizeof(TPM2_CAP) - \
#                            sizeof(UINT32)) / sizeof(TPMS_TAGGED_POLICY))
#TPM2_PRIVATE_VENDOR_SPECIFIC_BYTES = ((TPM2_MAX_RSA_KEY_BYTES / 2) * (3 + 2))
...
#TPM_AT_ANY   = (<TPM_AT>0x00000000) # In a command, a non-specific request for AC information. In a response, indicates that outputData is not meaningful
#TPM_AT_ERROR = (<TPM_AT>0x00000001) # Indicates a TCG defined, device-specific error
#TPM_AT_PV1   = (<TPM_AT>0x00000002) # Indicates the most significant 32 bits of a pairing value for the AC
#TPM_AT_VEND  = (<TPM_AT>0x80000000) # Value added to a TPM_AT to indicate a vendor-specific tag value
#
